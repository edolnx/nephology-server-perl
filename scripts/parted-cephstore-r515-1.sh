...
for DEV in sdb sdc sdd sde sdf sdg sdh sdi sdj sdk sdl sdm sdn sdo sdp sdq sdr sds sdt sdu sdv sdw sdx sdy
...
sudo parted -s -acylinder /dev/sdp mkpart osd-device-008-journal 1 100% || failed "mkpart 008-journal"
echo "Creating osd device 8 data label"
sudo parted -s -acylinder /dev/sdq mkpart osd-device-008-data 1 100% || failed "mkpart 008-data"
echo "Creating osd device 9 journal label"
sudo parted -s -acylinder /dev/sdr mkpart osd-device-009-journal 1 100% || failed "mkpart 009-journal"
echo "Creating osd device 9 data label"
sudo parted -s -acylinder /dev/sds mkpart osd-device-009-data 1 100% || failed "mkpart 009-data"
echo "Creating osd device 10 journal label"
sudo parted -s -acylinder /dev/sdt mkpart osd-device-010-journal 1 100% || failed "mkpart 010-journal"
echo "Creating osd device 10 data label"
sudo parted -s -acylinder /dev/sdu mkpart osd-device-010-data 1 100% || failed "mkpart 010-data"
echo "Creating osd device 11 journal label"
sudo parted -s -acylinder /dev/sdv mkpart osd-device-011-journal 1 100% || failed "mkpart 011-journal"
echo "Creating osd device 11 data label"
sudo parted -s -acylinder /dev/sdw mkpart osd-device-011-data 1 100% || failed "mkpart 011-data"
echo "Creating osd device 12 journal label"
sudo parted -s -acylinder /dev/sdx mkpart osd-device-012-journal 1 100% || failed "mkpart 012-journal"
echo "Creating osd device 12 data label"
sudo parted -s -acylinder /dev/sdy mkpart osd-device-012-data 1 100% || failed "mkpart 012-data"
